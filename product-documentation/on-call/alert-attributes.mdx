...
<Steps>
  <Step title="Navigate to attributes settings">
    Using the sidebar, navigate to **Settings → Alerts**
  </Step>
  <Step title="Access attributes configuration">
...
<Steps>
  <Step title="Navigate to final setup stage">
  ...
  <Step title="Verify accepted attributes">
