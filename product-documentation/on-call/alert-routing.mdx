...
<Steps>
  <Step title="Read attribute from alert">
    Read the impacted <Badge color="yellow">Service</Badge> from the alert attributes (e.g., "Billing API")
  </Step>
  <Step title="Find owner in catalog">
    Find which <Badge color="purple">Team</Badge> owns that service in your catalog (e.g., "Payments")
  </Step>
  <Step title="Page the team">
...
<Tabs>
  <Tab title="When to create incidents">
  ...
  <Tab title="When to skip incident creation">
