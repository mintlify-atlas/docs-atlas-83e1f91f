...
<Steps>
  ...
  <Step title="Use in workflow">
    Add step: "Post message to incident channel"
    - Message:
    ```
    📊 Dashboard: {Expression: Monitoring Dashboard}
    📖 Runbook: {Expression: Incident Runbook}
    💬 Team: {Affected Service → Owning Team → Slack Channel}
    ```
  </Step>
</Steps>
