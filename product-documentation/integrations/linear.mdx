...
<Steps>
  <Step title="Go to Settings > Integrations">
    Navigate to [Settings > Integrations](https://app.incident.io/settings/integrations) and click `Connect` next to Linear.

    <img src="/images/integrations/linear/linear-connect.png" alt="Connect Linear integration" />
  </Step>

  <Step title="Log into Linear">
    <Note>
  ...
  <Step title="Enable a Triage action for your team on Linear">
