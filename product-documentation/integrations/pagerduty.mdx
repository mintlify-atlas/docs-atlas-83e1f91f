...
<Steps>
  <Step title="Navigate to Integrations">
    Go to Settings > [Integrations](https://app.incident.io/settings/integrations)

    <img src="/images/integrations/pagerduty/pagerduty-integrations-page.png" alt="Settings > Integrations page" />
  </Step>

  <Step title="Connect PagerDuty">
    Press 'Connect' next to PagerDuty

    <img src="/images/integrations/pagerduty/pagerduty-connect.png" alt="PagerDuty integration with Connect button" />
  </Step>

  <Step title="Fetch your API key from PagerDuty">
    You'll need to create an API key by heading to your PagerDuty account, and navigating to **Integrations > API Keys**

    <img src="/images/integrations/pagerduty/pagerduty-api-menu.png" alt="PagerDuty Integrations menu showing API Keys option" />

    <Info>
    If you can't see the API Access Keys menu item, you probably don't have access to create API keys in PagerDuty.
    </Info>

    <img src="/images/integrations/pagerduty/pagerduty-api-keys.png" alt="API Access Keys page in PagerDuty" />

    Click **Create an API Key**

    <img src="/images/integrations/pagerduty/pagerduty-create-key.png" alt="Create API Key button" />

    Call it "incident.io"

    We do need write access, so leave the 'read-only key' box unchecked.

    <img src="/images/integrations/pagerduty/pagerduty-key-form.png" alt="API Key form showing name field and read-only checkbox" />
  ...
  <Step title="Choose your bot account">
    ...
    <img src="/images/integrations/pagerduty/pagerduty-bot-account.png" alt="Bot account selection dropdown" />
