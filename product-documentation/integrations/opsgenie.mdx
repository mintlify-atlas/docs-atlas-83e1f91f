...
<Steps>
  ...
  <Step title="Install Opsgenie">
    Press 'Install' next to Opsgenie

    <img src="/images/integrations/opsgenie/opsgenie-install.png" alt="Install Opsgenie integration" />
  </Step>

  <Step title="Fetch your API key from Opsgenie">
...
<iframe
  src="https://www.loom.com/embed/01b7976b413947ed93d9b9d1af820173"
  frameBorder="0"
  allowFullScreen
  style={{
    width: '100%',
