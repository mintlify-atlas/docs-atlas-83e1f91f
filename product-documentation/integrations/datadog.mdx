---
title: "Datadog"
description: "Connect Datadog monitors to incident.io for automatic incident creation and enrichment"
---

# Datadog

Looking for Datadog SIEM and how to stream audit logs? Please look at our [audit log help article here](https://help.incident.io/en/articles/7339034-audit-logs).
...
<img src="/images/integrations/datadog/legacy-triggers-1.png" alt="Datadog monitor information in incident channel" />
...
<img src="/images/integrations/datadog/legacy-triggers-2.png" alt="Datadog monitor in attachments and timeline" />
...
The final piece to set up is to configure incident.io to trigger incidents when a PagerDuty/OpsGenie alert occurs - details on how to do this can be found [here](https://help.incident.io/en/articles/5948111-can-we-automatically-create-incidents).
...
For more info on pinning items, check out our article on [incident timelines](https://help.incident.io/en/articles/5947891-generating-your-incident-timeline).
